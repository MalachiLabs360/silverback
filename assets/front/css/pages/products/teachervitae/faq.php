    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12 col-lg-6">
                <img class="img-fluid center-block" src="/assets/front/img/dreamstime.jpg" alt="drive10" style="z-index: 9; position: relative;">
            </div>
            <div class="col-md-12 col-lg-6">
                <div class="iq-accordion iq-mt-50">
                    <div class="iq-ad-block ad-active"> <a href="#" class="ad-title iq-tw-6 iq-font-grey">Q: What is Teacher Vitae?</a>
                        <div class="ad-details font_size_20">
                    ...
                    <div class="iq-ad-block"> <a href="#" class="ad-title iq-tw-6 iq-font-grey">Q: What are the top reasons educators chose Teacher Vitae?</a>
                        <div class="ad-details font_size_20">A: Teacher Vitae is easy for administrators and teachers to learn
                            and use. Forms are customized to meet the evaluation
                            requirements at both the state and district level. A unique tagging
                            systems ties all of the work in Teacher Vitae to the summative
                            evaluation. Customer service is top notch.
                        </div>
                    </div>
