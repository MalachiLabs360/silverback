<section id="software-features" class="overview-block-ptb iq-mt-50 software">
    ...
    <div class="container">
        <div class="row justify-content-end">
            <div class="col-lg-6">
                <h2 class="iq-tw-6 iq-mb-25">The Silverback Advantage</h2>
                <p class="font_size_20">An educational company offering a 360* view of the student, the classroom, the school, the district the teacher and the administration. Radically improving efficiencies while enhancing the teaching and learning experiences for all.</p>
