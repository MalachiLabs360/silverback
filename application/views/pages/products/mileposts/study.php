<section class="overview-block-ptb how-works Product-works grey-bg">
    <div class="container">
        <div class="row">
            <div class="col-lg-7">
                <a target="_blank" href="/assets/front/pdf/BoiseStateWhitepaper.pdf"><img class="img-fluid" src="/assets/front/img/mileposts_chart.jpg" alt="Boise State Whitepaper"></a>
            </div>
            <div class="col-lg-5 align-self-center">
                <h2 class="iq-tw-6 iq-mb-25">Efficacy Study:</h2>
                <p class="iq-font-15">The Boise State University conducted study
