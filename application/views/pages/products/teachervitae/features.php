      ...
      <div class="row">
          <div class="col-sm-12">
              <div class="heading-title">
                  ...
                  <p class="font_size_20">Teacher Vitae, Silverback’s Professional Evaluation and Observation Platform, offers a revolutionary way to organize and keep abreast of instructional effectiveness.</p>
              </div>
          </div>
      </div>
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <ul class="iq-mt-40 iq-list float-left">
                    ...
                    <li class="iq-tw-7"><i class="ion-android-done-all iq-mr-20 iq-font-blue iq-font-30"></i><span class="iq-font-black font_size_20">Customizable Forms, Templates and Rubrics with a wide variety of Field Types</span></li>
                    <li class="iq-tw-7"><i class="ion-android-done-all iq-mr-20 iq-font-blue iq-font-30"></i><span class="iq-font-black font_size_20">Unique Tagging System tying every observation and note to the State and/or District Summative Evaluation</span></li>
