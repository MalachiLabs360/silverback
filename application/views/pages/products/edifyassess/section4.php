<section id="software-features" class="overview-block-ptb iq-mt-50 software">
    ...
    <div class="container">
        <div class="row justify-content-end">
            <div class="col-lg-6">
                <h2 class="iq-tw-6 iq-mb-25">Assessment Generator</h2>
                ...
                <ul class="iq-mt-40 iq-list">
                    ...
                    <li class="iq-tw-6"><i class="ion-android-done-all iq-mr-10 iq-font-blue iq-font-30"></i><span class="iq-font-black">Appropriate remediation resources are automatically selected for each item</span></li>
                    <li class="iq-tw-6"><i class="ion-android-done-all iq-mr-10 iq-font-blue iq-font-30"></i><span class="iq-font-black">IEP modifications can be automatically made to the items to accommodate special needs students</span></li>
                </ul>
            </div>
        </div>
    </div>
