<section id="solutions" class="overview-block-ptb it-works">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4 col-lg-4 col-sm-4 solution" id="mileposts">
            ...
            <div class="col-md-4 col-lg-4 col-sm-4 solution" id="edify">
                <div class="iq-works-box text-left">
                    <div class="icon-bg text-center">
                        <img src="/assets/front/images/logos/edify.png" class="img-fluid" alt="Edify">
                    </div>
                      <p class="solution-description">More than 100,000 test items in varied item types enabling the creation of assessments that pinpoint skill gaps.<br><br><p>
                </div>
            </div>
        </div>
    </div>
