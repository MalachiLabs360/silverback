        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="heading-title">
                    ...
                    <p>Individualized instruction and assessments for students—observation, evaluation, professional development and portfolio options for teachers and administration</p>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 col-lg-4 solution" id="mileposts">
                <div class="iq-works-box text-left">
                    <div class="icon-bg text-center">
                        <img src="/assets/front/img/mileposts.png" class="img-fluid" alt="Mileposts">
                    </div>
            ...
            <div class="col-md-12 col-lg-4 solution" id="vitae">
                <div class="iq-works-box text-left">
                    <div class="icon-bg text-center">
                        <img src="/assets/front/img/vitae.png" class="img-fluid" alt="Vitae">
                    </div>
            ...
            <div class="col-md-12 col-lg-4 solution" id="edify">
                <div class="iq-works-box text-left">
                    <div class="icon-bg text-center">
                        <img src="/assets/front/img/edify.png" class="img-fluid" alt="Edify">
                    </div>
