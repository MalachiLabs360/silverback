            ...
            <div class="col-sm-12">
                <div class="owl-carousel" data-nav-dots="true" data-nav-arrow="false" data-items="3" data-sm-items="2" data-lg-items="3" data-md-items="3" data-autoplay="true">
                    ...
                    <div class="item">
                        <div class="iq-blog-box">
                            <div class="iq-blog-image clearfix">
                                <img class="img-fluid center-block" src="/assets/front/images/blog/03.jpg" alt="#">
                    ...
                    <div class="item">
                        <div class="iq-blog-box">
                            <div class="iq-blog-image clearfix">
                                <img class="img-fluid center-block" src="/assets/front/images/blog/02.jpg" alt="#">
                            </div>
                            <div class="iq-blog-detail">
                        ...
                        <div class="iq-blog-box">
                            <div class="iq-blog-image clearfix">
                                <div class="owl-carousel arrow-1" data-nav-dots="false" data-nav-arrow="true" data-items="1" data-xs-items="1" data-sm-items="1" data-md-items="1" data-lg-items="1" data-autoplay="true">
                                    <div class="item">
                                        <img class="img-fluid" src="/assets/front/images/blog/01.jpg" alt="#">
                                    </div>
                                    <div class="item">
                                        <img class="img-fluid" src="/assets/front/images/blog/02.jpg" alt="#">
                                    </div>
                                    <div class="item">
                                        <img class="img-fluid" src="/assets/front/images/blog/03.jpg" alt="#">
                                    </div>
                                </div>
                            </div>
                            <div class="iq-blog-detail">
