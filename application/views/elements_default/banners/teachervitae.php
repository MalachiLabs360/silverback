<section id="iq-home" class="iq-banner-08 overview-block-pt grey-bg">
    <div class="container">
        <div class="banner-text">
            <div class="row">
                <div class="col-lg-6">
                    <h1 class="text-uppercase iq-font-blue iq-tw-3"><b class="iq-tw-7">Teacher Vitae</b></h1>
                    <h3 class="text-uppercase iq-font-blue iq-tw-3" style="color: #54cbf5">Educator growth powered by professional learning portfolios</h3>
                    <p class="iq-font-black iq-pt-15 iq-mb-40">Teacher Vitae, Silverback’s Professional Development platform offers a revolutionary way to look at instructional effectiveness.</p>
                </div>
                <div class="col-lg-6">
