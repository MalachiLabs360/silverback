...
class Service_model extends ME_Model
{
	...
	public function appointment_by_clients($id)
	{
		$sql = "SELECT
							appointments.*,
							products.name as service_name,
	...
	public function days_off_by_date($day)
	{
	...
	public function days_off_by_daterange($range,$begin,$end)
	{
		if ($range=='d') {
	...
	public function events($range,$begin,$end)
	{
		...
		$days_off = $this->days_off_by_daterange($range,$begin,$end);
